/*
 ...
 > document.getElementsByClassName("slide-footer")
 < NodeList [<div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, <div class="slide-footer">, …] (171) = $5
 > document.getElementsByClassName("slide-footer")[10]
 < <div class="slide-footer">Autor: Dipl.-Inf. Karsten Schulz, Dortmund       EU-DSGVO       2016-05v1</div> = $6
 > document.getElementsByClassName("slide-footer")[10].textContent = "Hello"
 < "Hello" = $7
 > n[10].textContent = n[10].textContent + " / " + n.length
 < "11 / 171" = $8
